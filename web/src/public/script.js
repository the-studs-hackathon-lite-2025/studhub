...
settings.onclick = () => {
    ...
    <h3 class="w-full text-center mb-2">
        Bakgrunn
    </h3>
    ...
    <h3 class="w-full text-center mt-4 mb-2"> 
        Stasjon
    </h3>
    <select class="bn-select w-full bg-[#00000090] bg-opacity-65 backdrop-blur-sm border border-border outline-none" data-station="" id="rtd-input-bbe4a910-caa3-4f34-9dd1-1d687ffd1df4-select-station">
                    ...
                    <option value="HRA">Hegra stasjon</option><option value="HTO">Hauketo stasjon</option>
